...
bouquet = { 'PARIS' => 130, 'LISBON' => 120, 'OSAKA' => 130, 'SYDNEY' => 120, 'CANNES' => 110, 'LONDON' => 100,
            'BARCELONA' => 110, 'SANTORINI' => 100 }
...
loop do
  ...
  flowershop.add_to_order(item, quantity) if quantity > 0
end
...
my_hash = { Email: 'information@blossomhouse.com.au', Phone: '0452807003',
            Address: '8 Sunset Rd, Surry Hills, NSW2010', Website: 'www.Blossomhouse.com.au' }
